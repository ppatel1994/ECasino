  ...
  return (
    <>
      ...
      <div id="menu" className="hidden h-full w-full md:w-96 md:bg-ec-green-border md:right-0 bg-ec-green z-10 fixed">
        ...
        <div onClick={handleSetUpClick} className="flex flex-row hover:bg-ec-green-border md:hover:bg-ec-green mx-6 mb-6 rounded-lg space-x-10 space-y-3 cursor-pointer">
          <div className="rounded-full bg-ec-green-border md:bg-ec-green p-3">
      ...
      <nav className="sticky">
        <div className="p-2 flex flex-row">
          ...
          <div role="presentation" onClick={openMenu} className="cursor-pointer ms-auto m-5 p-4 hover:rounded-full hover:bg-ec-green-border">

...
function WithdrawForm() {
    return (
        <>
            ...
            <div><button type="button" className="mt-8 bg-ec-yellow text-white rounded-full font-bold p-2 px-10 hover:bg-ec-yellow-hover focus:ring focus:ring-ec-yellow">Withdraw All</button></div>
